    ...
    handlers: {
      POST: async ({ request }) => {
        try {
          ...
          console.error("POST /api/public/create-snapshot failed", error);
          return Response.json(
            {
              ok: false,
              error: error instanceof Error ? error.message : "Unexpected server error while creating the snapshot.",
            },
